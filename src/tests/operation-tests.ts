...
function sdiff(a: string[], b: string[]): string[] {
    const d = new TernaryStringSet(a).symmetricDifference(new TernaryStringSet(b));
    return Array.from(d);
}
...
test("Union", () => {
    ...
    expect(union(["fish", "horse", "monkey", "rhino"], ["emu", "monkey", "mouse"]))
...
test("Intersection", () => {
    ...
    expect(inter(["fish", "frog", "horse", "monkey", "rhino"], ["emu", "frog", "monkey", "mouse"]))
        .toEqual(["frog", "monkey"]);
});
...
test("Subtraction", () => {
    ...
    expect(sub(["fish", "frog", "horse", "monkey", "rhino"], ["emu", "frog", "monkey", "mouse"]))
...
test("Symmetric difference", () => {
    ...
    expect(sdiff(["fish", "frog", "horse", "monkey", "rhino"], ["emu", "frog", "monkey", "mouse"]))
